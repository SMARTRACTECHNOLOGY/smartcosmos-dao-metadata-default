...
@Component
public class SpringDataPageMetadataOwnerProjectionToMetadataOwnerResponsePageConverter
    extends ConversionServiceAwareConverter<org.springframework.data.domain.Page<MetadataOwnerProjection>, Page<MetadataOwnerResponse>> {
    ...
    @Override
    public Page<MetadataOwnerResponse> convert(org.springframework.data.domain.Page<MetadataOwnerProjection> page) {
